...
F8 Studio shows the current instance and namespace as a pair in the top bar, and its Connect screen creates, switches, and drops the namespaces of an instance. See [studio](/fallen-8-core/studio/).
