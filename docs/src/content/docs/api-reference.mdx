...
[Observability](/observability/). For the versioning scheme, authentication, and an
endpoint map with prose, see [REST API](/rest-api/).
...
from this site to your own server ([Security](/security/)). To send real requests,
run the app and use its bundled Scalar UI at `/scalar/v0.1` (Development only). The raw document
is published at [openapi/v0.1.json](https://docs.fallen-8.com/openapi/v0.1.json).
