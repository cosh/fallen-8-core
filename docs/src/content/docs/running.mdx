...
| `F8_API_KEY` | *(unset)* | Set it and the **entire** service requires the key; unset = open ([Security](/fallen-8-core/security/)) |
...
[DEBUGGING.md](https://github.com/cosh/fallen-8-core/blob/main/DEBUGGING.md).
