...
- [Studio](/studio/): the Traverse screen's two scenario tabs capture the fragments you authored with "Save as stored query…", and its **Stored queries** tab manages the whole library in one kind-columned table
