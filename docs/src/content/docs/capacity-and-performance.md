...
| Engine | 0.3.0.0, commit `32b389fa41` |
| Profile | `full` |
| Measured | 2026-08-05 18:25 UTC |
...
| --- | --- | --- |
| serial (1 producer) | 368 writes/s | 11,072 |
| 32 concurrent producers | 11,698 writes/s | 200,000 |

That is roughly 31.8x from group commit alone, on single-element writes with the WAL on, and the serial latency floor is unchanged: a group of one still fsyncs immediately.
...
| --- | --- |
| 1,002,000 elements | 66.8 ms |
| 4,002,000 elements | 232.3 ms |
| 20,001,000 elements | 1081.2 ms |
...
| --- | --- | --- |
| 500,000 vertices, 5,000,000 edges | 5 | 369,530,032 edges/s |
| 2,000,000 vertices, 20,000,000 edges | 5 | 299,788,499 edges/s |
| 10,000,000 vertices, 100,000,000 edges | 5 | 283,818,459 edges/s |
