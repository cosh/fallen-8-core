...
To put a face on an in-browser graph, Studio's canvas component renders it straight from your
interop layer; the walk-through from a WASM engine to the canvas to the full embedded Studio is
