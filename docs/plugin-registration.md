...
This is the same idea as [stored queries](stored-queries.md), lifted from a *fragment* (a
...
mechanism [stored queries](stored-queries.md) and subgraph recipes use. If a plugin's source fails
...
- [plugins.md](plugins.md) — the plugin model, families, and the built-ins.
- [stored-queries.md](stored-queries.md) — the fragment-shaped sibling this generalizes.
- [security.md](security.md) — the dynamic-code / plugin-registration trust boundary.
