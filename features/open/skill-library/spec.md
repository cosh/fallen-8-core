...
>   [integrations](../../done/integrations/spec.md) feature adds a provider contract an agent is
...
The [integrations](../../done/integrations/spec.md) feature's stated bar is that an agent can
...
3. **A skill cannot verify the thing these skills teach.** The v1 harness can compile a delegate
   ...
   precisely why [integrations](../../done/integrations/spec.md) makes the conformance
