...
(default `stoic_hellman_728/phi4-f8-mini:v0.0.35`) and tags it `phi4-f8-mini`, so the UI default
works out of the box; it also fetches and tags `phi4-f8` (+ `F8_PHI4F8_REPO`) by default — set
